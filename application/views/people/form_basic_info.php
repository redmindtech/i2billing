...
<div class="form-group form-group-sm">	
	<?php echo form_label($this->lang->line('additinal_phone_number'), 'additinal_phone_number', array('class'=>'control-label col-xs-3')); ?>
	<div class='col-xs-8'>
		<div class="input-group">
			<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-phone"></span></span>
			<?php echo form_input(array(
					'name'=>'additinal_phone_number',
					'id'=>'additinal_phone_number',
					'class'=>'form-control input-sm',
					'value'=>$person_info->additinal_phone_number)
					);?>
		</div>
	</div>
</div>
